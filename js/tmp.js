...
var tradegothic = {
 ...
 sIFR.replace(tradegothic, {
   selector: 'h2.sifr'
   ,css: [
     '.sIFR-root { text-align: left; font-size:29px;color: #0066a4; }'
     ,'a { text-decoration: none; color:#0066a4;}'
     ,'a:link { color: #0066a4; }'
     ,'a:hover { color: #338bc1; }'
   ],
    wmode: 'transparent'
 });

 sIFR.replace(tradegothic, {
   selector: 'h2.sifr-big'
   ,css: [
     '.sIFR-root { text-align: left; font-size:40px;color: #0066a4; }'
     ,'a { text-decoration: none; color:#0066a4;}'
     ,'a:link { color: #0066a4; }'
     ,'a:hover { color: #338bc1; }'
   ],
...
var sergeshand = {
   src: '/sifr/sergeshand.swf'
   ,selector: 'h4.sifr'
 };


 sIFR.useStyleCheck = true;
 sIFR.activate(sergeshand);

 sIFR.replace(sergeshand, {
   selector: 'h4.sifr'
   ,css: [
     '.sIFR-root { text-align: left; font-size:12px;color: #707070; text-transform:uppercase }'
     ,'a { text-decoration: none; color:#707070; text-transform:uppercase}'
     ,'a:link { color: #707070; text-transform:uppercase}'
     ,'a:hover { color: #707070; text-transform:uppercase}'
   ],
    wmode: 'transparent'
 });/*
...
var tb_pathToImage = "img/add.png";
